...
def iaml212cw2_q2_1():
    ...
    ax[1].axis('off')
    fig.savefig('q2.1.jpg',bbox_inches='tight')
...
def iaml212cw2_q2_3():
    ...
    for k in k_values_list:
        ...
        fig.savefig('q2.3_{0}.jpg'.format(k),bbox_inches='tight')
...
def iaml212cw2_q2_6():
    ...
    plt.grid()
    plt.savefig('q2.6.jpg',bbox_inches='tight')
...
def iaml212cw2_q2_7():
    ...
    plt.savefig('q2.7.jpg', bbox_inches='tight')
    plt.show()
